...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if (fase == 2){
                    ...
                    if( segundos > 0 && minutos ==0 &&  final == 0 && segundos <= primeira_fase_comeco){
                                        ...
                                        if(segundos ==2){   
                                        al_draw_text(font2, al_map_rgb(1, 1, 1), X_SCREEN-480, Y_SCREEN -60, 0, "QUE DIMENSÃO É ESSA? ");
                                        
                                        al_draw_text(font2, al_map_rgb(1, 1, 1), X_SCREEN-480, Y_SCREEN -30, 0, "O QUE VOCÊ ESTÁ PLANEJANDO, ZURC??!");
                                        }
                                        if(segundos >= 3 && segundos <= 5){   
                                        personagem=2;
                                            al_draw_text(font2, al_map_rgb(1, 1, 1), X_SCREEN-480, Y_SCREEN -60, 0, "Seu fim será amargo");
                                            al_draw_text(font2, al_map_rgb(1, 1, 1), X_SCREEN-480, Y_SCREEN -30, 0, "Buzz Lightear!");
                                        }
                                        if(segundos > 5){
                                            personagem =0;
            ...
            if (final == 1) {
                ...
                if(tiro_longo ==1){
al_draw_text(font, cor, 300, 300, 0,"longooooooooo");                }
                al_flip_display();

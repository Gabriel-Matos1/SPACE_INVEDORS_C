...
int main() {
    ...
    Boss2 vilao2;
    vilao2.bitmap = al_load_bitmap("SpaceShipSamples/Magicfly_47x65.png");
    if (!vilao2.bitmap) {
        printf("Falha ao carregar a sprite da bomba!\n");
        al_destroy_bitmap(sprite.bitmap);
        al_destroy_display(display);
    ...
    Bomba bomba;
    bomba.bitmap = al_load_bitmap("SpaceShipSamples/UFO_PlasmaShield_Pink_69x69.png");
    if (!bomba.bitmap) {
        printf("Falha ao carregar a sprite da bomba!\n");
        al_destroy_bitmap(sprite.bitmap);
        al_destroy_display(display);
    ...
    cor1[3].bitmap = al_load_bitmap("SpaceShipSamples/cor.png");
    ...
    cor1[3].x = X_SCREEN+5; cor1[3].y = 300; cor1[3].active = true;


    //! ----------------------------------------------CONFIGURAÇÕES DOS ELEMENTOS GERAL --------------------------------------------------


    ALLEGRO_BITMAP *fundo = al_load_bitmap("SpaceShipSamples/pngtree-digital-game-background-picture-image_1598113.png");
    ...
    while (running) {
        ...
        if (event.type == ALLEGRO_EVENT_TIMER) {
            ...
            if (inicio) {
                    ...
                    if (cont == 4 && sprite.hits >= 4 ) {
                        morreu = true;
                    }

                    if (cont == 3 && sprite.hits >= 3 ) {
                        morreu = true;
                    }
                ...
                if(fase ==1){
                    ...
                    if (cor1[3].active) {
                        if (cor1[3].x + al_get_bitmap_width(cor1[3].bitmap) > x && 
                            cor1[3].x < x + al_get_bitmap_width(sprite.bitmap) &&
                            cor1[3].y + al_get_bitmap_height(cor1[3].bitmap) > y &&
                            cor1[3].y < y + al_get_bitmap_height(sprite.bitmap)) {
                    ...
                    if(segundos >= 2){
                        cor1[3].x -= 10;
                            al_draw_scaled_bitmap(
                                cor1[3].bitmap, 
                                0, 0,                                      
                                al_get_bitmap_width(cor1[3].bitmap),      
                                al_get_bitmap_height(cor1[3].bitmap),     
                                cor1[3].x, 300,                  
